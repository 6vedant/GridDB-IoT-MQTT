...
"""A MQTT to GridDB Bridge
This script receives MQTT data and saves those to GridDB.
"""
...
def on_message(client, userdata, msg):
    ...
    if sensor_data is not None:
        _send_sensor_data_to_griddbdb(sensor_data)
...
def _send_sensor_data_to_griddb(sensor_data):
    json_body = [
        {
